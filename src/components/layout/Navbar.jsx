...
const Navbar = ({ navigateTo }) => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 p-4">
            <nav className={`container mx-auto px-4 sm:px-6 py-3 rounded-full transition-all duration-300 ${navClasses}`}>
            ...
            {isMenuOpen && (
                <div className="md:hidden fixed inset-0 bg-gray-900/95 z-40 flex flex-col items-center justify-center space-y-5 overflow-y-auto py-8">
                    ...
                    <a href="#" onClick={() => handleNavigate('ValuedMembers')} className="text-xl hover:text-amber-300">Valued Members</a>
                    <a href="#" onClick={() => handleNavigate('InsurancePartner')} className="text-xl hover:text-amber-300">Insurance Partner</a>
                    <a href="#" onClick={() => handleNavigate('CustomerSupport')} className="text-xl hover:text-amber-300">Customer Support</a>
                    <a href="#" onClick={() => handleNavigate('TermsAndConditions')} className="text-xl hover:text-amber-300">Terms & Conditions</a>
                    <a href="#" onClick={() => handleNavigate('PrivacyPolicy')} className="text-xl hover:text-amber-300">Privacy Policy</a>
                    <a href="#" onClick={() => handleNavigate('ReturnAndRefundPolicy')} className="text-xl hover:text-amber-300">Return & Refund Policy</a>
                    <a href="#" onClick={() => handleNavigate('Registration')} className="mt-6 block w-auto btn-gold-gradient text-green-900 font-bold py-3 px-8 rounded-full">Register</a>
                </div>
            )}
        </header>
    );
